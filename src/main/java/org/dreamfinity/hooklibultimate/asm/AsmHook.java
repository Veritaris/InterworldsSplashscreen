...
import org.dreamfinity.hooklibultimate.asm.HookInjectorFactory.MethodEnter;
import org.dreamfinity.hooklibultimate.asm.HookInjectorFactory.MethodExit;
...
public class AsmHook implements Cloneable, Comparable<AsmHook> {
    ...
    public class Builder extends AsmHook {
        ...
        public Builder addTargetMethodParameters(Type... parameterTypes) {
            Collections.addAll(AsmHook.this.targetMethodParameters, parameterTypes);
            return this;
        }
